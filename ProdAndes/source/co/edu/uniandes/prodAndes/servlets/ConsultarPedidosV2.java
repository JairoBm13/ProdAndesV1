...
public class ConsultarPedidosV2 extends ServletTemplate{
	...
	public void escribirContenido(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(fachada.getTipoUsuario()==1 || (fachada.getTipoUsuario()==3 && fachada.getOperarioVal().isGerente())){
			if(consultado == null){
				...
				respuesta.println("								<span>Consultar pedidos:</span>");
				...
				respuesta.println("								<label for=\"costo\">Costo:</label>");
				respuesta.println("								<!--mira que es ese algo-->");
				respuesta.println("							    <div class=\"input-group\">");
				respuesta.println("									<input type=\"number\" min=\"0\" step=\"1\" id=\"costo\" name=\"costo\"  class=\"form-control\">");
				respuesta.println("									<span class=\"input-group-addon\">");
				respuesta.println("										<span class=\"glyphicon glyphicon-asterisk\">");
				respuesta.println("										</span>");
				respuesta.println("									</span>");
				...
				ArrayList<Pedido> etapas = fachada.darPedidosV2(tipoMaterial, costo, pagina);
				...
				respuesta.println("	<input type=\"hidden\" name=\"costo\" value=\""+costo+"\">");
