...
public class ConsultarEtapas2 extends ServletTemplate{
	...
	public void escribirContenido(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(fachada.getTipoUsuario()==1 || (fachada.getTipoUsuario()==3 && fachada.getOperarioVal().isGerente())){
			if(consultado == null){
				...
				ArrayList<EtapaProduccion> etapas = fachada.darEjecucionEtapasV2(fechaInicio, fechaFin, idMaterial, tipoMaterial, idPedido, minCantidad, maxCantidad, pagina);
